# AGENTS.md — A9 Website (production)

This file is MANDATORY for any AI agent editing this repository.
...
## After reading the universal rules above, you MUST also read:

- `docs/a9-development.md` — A9 project-specific rules (i18n {t,lang}, data shapes like tags=array, zoom rules, admin conventions, known pitfalls, git/secrets).
- `docs/ai-agent-engineering-constitution.md` — full constitution with risk matrix and PR checklist.
