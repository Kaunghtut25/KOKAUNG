...
export const REGION_CITIES: BusCity[] = [
  ...
  { city: "Kyauktada", cityMY: "ကျောက်တံတား", region: "Yangon", regionMY: "ရန်ကုန်တိုင်းဒေသကြီး", popular: false },
  { city: "Pabedan", cityMY: "ပန်းဘဲတန်း", region: "Yangon", regionMY: "ရန်ကုန်", popular: false },
  { city: "Latha", cityMY: "လသာ", region: "Yangon", regionMY: "ရန်ကုန်", popular: false },
  { city: "Lanmadaw", cityMY: "လမ်းမတော်", region: "Yangon", regionMY: "ရန်ကုန်", popular: false },
  { city: "Dagon", cityMY: "ဒဂုံ", region: "Yangon", regionMY: "ရန်ကုန်", popular: false },
  { city: "Ahlon", cityMY: "အလုံ", region: "Yangon", regionMY: "ရန်ကုန်", popular: false },
  { city: "Kyimyindaing", cityMY: "ကြည့်မြင်တိုင်", region: "Yangon", regionMY: "ရန်ကုန်", popular: false },
  { city: "Sanchaung", cityMY: "စမ်းချောင်း", region: "Yangon", regionMY: "ရန်ကုန်", popular: false },
  { city: "Botahtaung", cityMY: "ဗိုလ်တထောင်", region: "Yangon", regionMY: "ရန်ကုန်", popular: false },
  { city: "Pazundaung", cityMY: "ပုဇွန်တောင်", region: "Yangon", regionMY: "ရန်ကုန်", popular: false },
  { city: "Thingangyun", cityMY: "သင်္ဃန်းကျွန်း", region: "Yangon", regionMY: "ရန်ကုန်", popular: false },
  { city: "Yankin", cityMY: "ရန်ကင်း", region: "Yangon", regionMY: "ရန်ကုန်", popular: false },
  { city: "South Okkalapa", cityMY: "တောင်ဥက္ကလာပ", region: "Yangon", regionMY: "ရန်ကုန်", popular: false },
  { city: "North Okkalapa", cityMY: "မြောက်ဥက္ကလာပ", region: "Yangon", regionMY: "ရန်ကုန်", popular: false },
  { city: "Tamwe", cityMY: "တာမွေ", region: "Yangon", regionMY: "ရန်ကုန်", popular: false },
  { city: "Thaketa", cityMY: "သာကေတ", region: "Yangon", regionMY: "ရန်ကုန်", popular: false },
  { city: "Dawbon", cityMY: "ဒေါပုံ", region: "Yangon", regionMY: "ရန်ကုန်", popular: false },
  { city: "Mingala Taungnyunt", cityMY: "မင်္ဂလာတောင်ညွန့်", region: "Yangon", regionMY: "ရန်ကုန်", popular: false },
  { city: "Insein", cityMY: "အင်းစိန်", region: "Yangon", regionMY: "ရန်ကုန်", popular: false },
  { city: "Mingaladon", cityMY: "မင်္ဂလာဒုံ", region: "Yangon", regionMY: "ရန်ကုန်", popular: false },
  { city: "Mayangone", cityMY: "မယန်းကုန်း", region: "Yangon", regionMY: "ရန်ကုန်", popular: false },
  { city: "Hlaing", cityMY: "လှိုင်", region: "Yangon", regionMY: "ရန်ကုန်", popular: false },
  { city: "Kamayut", cityMY: "ကမရွတ်", region: "Yangon", regionMY: "ရန်ကုန်", popular: false },
  { city: "Bahan", cityMY: "ဗဟန်း", region: "Yangon", regionMY: "ရန်ကုန်", popular: false },
  { city: "Seikkan", cityMY: "ဆိပ်ကမ်း", region: "Yangon", regionMY: "ရန်ကုန်", popular: false },
  ...
  { city: "North Dagon", cityMY: "မြောက်ဒဂုံ", region: "Yangon", regionMY: "ရန်ကုန်", popular: false },
  { city: "South Dagon", cityMY: "တောင်ဒဂုံ", region: "Yangon", regionMY: "ရန်ကုန်", popular: false },
  { city: "East Dagon", cityMY: "အရှေ့ဒဂုံ", region: "Yangon", regionMY: "ရန်ကုန်", popular: false },
  { city: "Dagon Seikkan", cityMY: "ဒဂုံဆိပ်ကမ်း", region: "Yangon", regionMY: "ရန်ကုန်", popular: false },
  { city: "Shwepyitha", cityMY: "ရွှေပြည်သာ", region: "Yangon", regionMY: "ရန်ကုန်", popular: false },
