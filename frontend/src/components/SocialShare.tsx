    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginTop: 16 }}>
      ...
      {links.map((l) => (
        <a
          ...
          onMouseEnter={(e) => { e.currentTarget.style.background = l.color; e.currentTarget.style.color = 'white'; }}
          onMouseLeave={(e) => { e.currentTarget.style.background = '#f5f5f5'; e.currentTarget.style.color = l.color; }}
        >
          {l.icon}
        </a>
      ))}
