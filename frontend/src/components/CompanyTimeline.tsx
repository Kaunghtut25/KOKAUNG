...
export default function CompanyTimeline({
  ...
  const items = Array.isArray(milestones) && milestones.length > 0 ? milestones : DEFAULT_MILESTONES;
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '40px 20px' }}>
      <h2 style={{ textAlign: 'center', fontFamily: "'Playfair Display',serif", fontSize: 28, color: '#0A1628', marginBottom: 32 }}>{title}</h2>
