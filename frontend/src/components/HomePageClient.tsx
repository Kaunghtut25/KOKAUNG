              ...
              <form onSubmit={handleSearch} className="space-y-3">
                {activeTab==="multicity" ? (<>
                  ...
                  <div className="flex flex-col md:flex-row gap-3 items-end flex-wrap">
                    ...
                    <div className="w-full md:w-[180px]"><label className="block text-gray-500 text-xs uppercase tracking-wider mb-1"><span className="text-[#D4AF37]">🛂</span> {t("home.client")}</label><div className="flex bg-gray-50 border border-gray-200 rounded-lg p-1"><button type="button" onClick={()=>setClientType('local')} className={`flex-1 py-1.5 text-xs font-medium min-h-[44px] flex items-center justify-center rounded-md transition-all ${clientType==='local'?'bg-[#D4AF37] text-[#0A1628] shadow-sm':'text-gray-500 hover:text-gray-900'}`}>🇲🇲 {t("home.local")}</button><button type="button" onClick={()=>setClientType('foreigner')} className={`flex-1 py-1.5 text-xs font-medium min-h-[44px] flex items-center justify-center rounded-md transition-all ${clientType==='foreigner'?'bg-[#D4AF37] text-[#0A1628] shadow-sm':'text-gray-500 hover:text-gray-900'}`}>🌏 {t("home.foreigner")}</button></div></div>
                  ...
                  <div className="grid grid-cols-1 md:flex md:flex-row gap-3">
                    ...
                    <button type="button" onClick={swapAirports} className="hidden md:flex items-center justify-center w-10 h-10 mt-6 rounded-full bg-gray-100 border border-gray-200 text-gray-600 hover:text-gray-600 hover:border-[#D4AF37]/50 transition-all cursor-pointer flex-shrink-0" title={t("home.swapAirports")}>⇄</button>
