...
const FALLBACK_IMAGE = 'https://images.unsplash.com/photo-1566073771259-6a8506099945?w=600&h=400&fit=crop';
  ...
  return (
    ...
    >
      ...
      <div className="relative h-[300px] w-full overflow-hidden bg-gray-200">
        ...
        {/* Rooms badge */}
        <span
          className={`absolute top-4 right-4 px-3 py-1 rounded-full text-xs font-medium backdrop-blur-sm border ${
            roomsAvailable === 0
