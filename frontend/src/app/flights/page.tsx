    ...
    <main className="min-h-screen bg-[#0A1628]">
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-3 md:gap-6 flex-wrap">
                          <div className="text-center">
                            ...
                            <p className="text-gray-300 text-xs">{firstSeg.departure.iataCode}</p>
                          </div>

                          <div className="flex-1 flex flex-col items-center min-w-[100px]">
                            <p className="text-gray-300 text-xs mb-1">{formatDuration(itin.segments.reduce((acc: number, s: any) => {
                            ...
                            <p className="text-gray-300 text-xs mt-1">{t(itin.segments.length - 1 === 0 ? "flights.nonstop" : itin.segments.length - 1 === 1 ? "flights.oneStop" : "flights.stops", { count: itin.segments.length - 1 })}</p>
                          </div>

                          <div className="text-center">
                            <p className="text-white text-xl md:text-2xl font-bold">{formatTime(lastSeg.arrival.at)}</p>
                            <p className="text-gray-300 text-xs">{lastSeg.arrival.iataCode}</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-row lg:flex-col items-center lg:items-end gap-4 lg:gap-3 lg:min-w-[180px]">
                        <div className="text-right">
                          <p className="text-gray-300 text-xs">{offer.price.currency}</p>
                          ...
                          <p className="text-gray-300 text-xs">{t("flights.perAdult")}</p>
                        </div>
                        <Link
            ...
            {popularRoutes.map((route, i) => (
              ...
              >
                ...
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-gray-300 text-xs">{route.airline}</span>
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-gray-300 text-xs">{route.duration} · {route.stops}</p>
                  </div>
                  <Link
      ...
      <section className="py-16 border-t border-[#D4AF37]/10">
        <div className="max-w-6xl mx-auto px-4">
          ...
          {/* Gold Tier */}
          <div className="mb-10">
            <h3 className="text-gray-300 text-sm font-semibold uppercase tracking-wider text-center mb-6">
              {t("flights.tierGold")}
            </h3>
