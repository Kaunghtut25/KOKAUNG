    ...
    <div className="min-h-screen bg-[#0A1628]">
      ...
      <section className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto pb-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Mission */}
          <div className="glass-card p-8 sm:p-10 hover:border-[#D4AF37]/40 transition-all duration-300 group">
      ...
      <section className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto pb-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
          {values.map((v) => (
            <div key={v.title} className="glass-card p-6 text-center hover:border-[#D4AF37]/30 transition-all duration-300 group">
      ...
      <section className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto pb-20">
        <div className="glass-card p-8 sm:p-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {services.map((svc) => (
              <div key={svc} className="flex items-center gap-3 px-4 py-3 rounded-xl bg-white/5 border border-white/5 hover:border-[#D4AF37]/30 hover:bg-[#D4AF37]/5 transition-all duration-200">
                <div className="w-2 h-2 rounded-full bg-[#D4AF37] flex-shrink-0" />
                <span className="text-white/80 text-sm">{svc}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto pb-20">
        <div className="text-center mb-10">
          <h2 className="text-3xl sm:text-4xl font-bold mb-3" style={{ fontFamily: "'Playfair Display', serif" }}>
            <span className="bg-gradient-to-r from-[#D4AF37] to-[#F5A623] bg-clip-text text-transparent">
              Why Choose A9 Global?
            </span>
          </h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl mx-auto">
          {whyChooseUs.map((item, idx) => (
            <div key={idx} className="flex items-start gap-3 p-4 rounded-xl bg-white/[0.02] border border-white/5 hover:border-[#D4AF37]/20 transition-all">
      ...
      <section className="border-y border-white/5 bg-[#1B2A4A]/50 backdrop-blur">
        <div className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto py-14">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-4xl sm:text-5xl font-bold text-[#D4AF37] mb-2" style={{ fontFamily: "'Playfair Display', serif" }}>10+</div>
              <p className="text-white/50 text-sm uppercase tracking-wider">Years of Experience</p>
            </div>
            <div>
              <div className="text-4xl sm:text-5xl font-bold text-[#D4AF37] mb-2" style={{ fontFamily: "'Playfair Display', serif" }}>5,000+</div>
              <p className="text-white/50 text-sm uppercase tracking-wider">Happy Travelers</p>
            </div>
            <div>
              <div className="text-4xl sm:text-5xl font-bold text-[#D4AF37] mb-2" style={{ fontFamily: "'Playfair Display', serif" }}>50+</div>
              <p className="text-white/50 text-sm uppercase tracking-wider">Destinations</p>
            </div>
            <div>
              <div className="text-4xl sm:text-5xl font-bold text-[#D4AF37] mb-2" style={{ fontFamily: "'Playfair Display', serif" }}>24/7</div>
              <p className="text-white/50 text-sm uppercase tracking-wider">Support</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto py-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {teamMembers.map((member) => (
            <div key={member.name} className="glass-card p-6 text-center hover:border-[#D4AF37]/30 transition-all duration-300 group">
