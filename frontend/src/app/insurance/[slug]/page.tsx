  ...
  return (
    <main style={{ minHeight: '100vh', background: '#f8f9fa' }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-24 pb-2">
        <Link href="/insurance" className="inline-flex items-center gap-2 text-gray-400 hover:text-[#D4AF37] transition-colors text-sm">
...
<section style={{ maxWidth: 800, margin: '0 auto', padding: '40px 20px' }}>
      ...
      <RelatedItems section="insurance" excludeSlug={params.slug} />
</main>
  );
}
