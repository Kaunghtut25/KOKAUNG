...
function transformHotel(h: Record<string, unknown>) {
  ...
  return {
    ...
    name: hotelName,
    location: loc,
    rating: Number(h.rating) > 0 ? Number(h.rating) : 0,
    reviewCount: Number(h.reviewCount) > 0 ? Number(h.reviewCount) : 0,
    pricePerNightMMK: Number(h.pricePerNightMMK || h.priceMMK) > 0 ? Number(h.pricePerNightMMK || h.priceMMK) : 0,
    pricePerNightUSD: Number(h.pricePerNightUSD || h.priceUSD) > 0 ? Number(h.pricePerNightUSD || h.priceUSD) : 0,
    priceOnRequest: !(Number(h.pricePerNightMMK || h.priceMMK) > 0) && !(Number(h.pricePerNightUSD || h.priceUSD) > 0),
    images,
    ...
    availableRooms: Number(h.availableRooms) > 0 ? Number(h.availableRooms) : 0,
