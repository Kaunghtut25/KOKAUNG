  ...
  const fetchHotels = useCallback(async () => {
    ...
    try {
      ...
      const fallbackHotels: Hotel[] = [
        { _id: 'fh1', slug: 'fbh1', name: 'Sule Shangri-La Yangon', location: 'Yangon', rating: 4.7, pricePerNightMMK: 180000, pricePerNightUSD: 86, images: ['https://images.unsplash.com/photo-1566073771259-6a8506099945?w=600&h=400&fit=crop'], amenities: [], availableRooms: 20, description: '', reviewCount: 320, stars: 5 },
        { _id: 'fh2', slug: 'fbh2', name: 'The Strand Yangon', location: 'Yangon', rating: 4.9, pricePerNightMMK: 350000, pricePerNightUSD: 167, images: ['https://images.unsplash.com/photo-1566665798629-69f7e7ba6ecf?w=600&h=400&fit=crop'], amenities: [], availableRooms: 8, description: '', reviewCount: 412, stars: 5 },
        { _id: 'fh3', slug: 'fbh3', name: 'Aureum Palace Bagan', location: 'Bagan', rating: 4.8, pricePerNightMMK: 220000, pricePerNightUSD: 105, images: ['https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=600&h=400&fit=crop'], amenities: [], availableRooms: 30, description: '', reviewCount: 225, stars: 5 },
        { _id: 'fh4', slug: 'fbh4', name: 'Inle Princess Resort', location: 'Inle Lake', rating: 4.6, pricePerNightMMK: 160000, pricePerNightUSD: 76, images: ['https://images.unsplash.com/photo-1582719508461-905c673771fd?w=600&h=400&fit=crop'], amenities: [], availableRooms: 25, description: '', reviewCount: 178, stars: 4 },
        { _id: 'fh5', slug: 'fbh5', name: 'Ngapali Bay Hotel', location: 'Ngapali Beach', rating: 4.7, pricePerNightMMK: 250000, pricePerNightUSD: 119, images: ['https://images.unsplash.com/photo-1570789210967-2cac24afeb00?w=600&h=400&fit=crop'], amenities: [], availableRooms: 40, description: '', reviewCount: 168, stars: 5 },
        { _id: 'fh6', slug: 'fbh6', name: 'Mandalay Hill Resort', location: 'Mandalay', rating: 4.3, pricePerNightMMK: 120000, pricePerNightUSD: 57, images: ['https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=600&h=400&fit=crop'], amenities: [], availableRooms: 55, description: '', reviewCount: 190, stars: 4 },
      ];
