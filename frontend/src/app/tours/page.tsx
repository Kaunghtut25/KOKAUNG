  ...
  const fetchTours = useCallback(async () => {
    ...
    try {
      ...
      const fallbackTours: Tour[] = [
        { _id: 'ft1', slug: 'fallback-1', title: 'Golden Land Explorer', destination: 'Yangon - Bagan - Mandalay', description: '', priceMMK: 1850000, priceUSD: 881, duration: '8D/7N', groupSize: 20, rating: 4.8, reviewCount: 142, images: ['https://images.unsplash.com/photo-1570167574777-7e5c2c5e60b5?w=600&h=400&fit=crop'], amenities: [], itinerary: [], included: [], excluded: [], featured: true, createdAt: '' },
        { _id: 'ft2', slug: 'fallback-2', title: 'Bagan Sunrise Discovery', destination: 'Bagan', description: '', priceMMK: 950000, priceUSD: 452, duration: '5D/4N', groupSize: 15, rating: 4.9, reviewCount: 98, images: ['https://images.unsplash.com/photo-1558704475-1428913b4c6b?w=600&h=400&fit=crop'], amenities: [], itinerary: [], included: [], excluded: [], featured: true, createdAt: '' },
        { _id: 'ft3', slug: 'fallback-3', title: 'Mandalay Royal Heritage', destination: 'Mandalay', description: '', priceMMK: 750000, priceUSD: 357, duration: '4D/3N', groupSize: 20, rating: 4.6, reviewCount: 67, images: ['https://images.unsplash.com/photo-1590474251443-ea19bb0f4e89?w=600&h=400&fit=crop'], amenities: [], itinerary: [], included: [], excluded: [], featured: false, createdAt: '' },
        { _id: 'ft4', slug: 'fallback-4', title: 'Inle Lake Serenity', destination: 'Inle Lake', description: '', priceMMK: 1100000, priceUSD: 524, duration: '5D/4N', groupSize: 16, rating: 4.7, reviewCount: 85, images: ['https://images.unsplash.com/photo-1583431815168-55a35bfefbd3?w=600&h=400&fit=crop'], amenities: [], itinerary: [], included: [], excluded: [], featured: true, createdAt: '' },
        { _id: 'ft5', slug: 'fallback-5', title: 'Ngapali Beach Escape', destination: 'Ngapali Beach', description: '', priceMMK: 1350000, priceUSD: 643, duration: '4D/3N', groupSize: 18, rating: 4.5, reviewCount: 52, images: ['https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=600&h=400&fit=crop'], amenities: [], itinerary: [], included: [], excluded: [], featured: false, createdAt: '' },
        { _id: 'ft6', slug: 'fallback-6', title: 'Yangon Cultural Tour', destination: 'Yangon', description: '', priceMMK: 450000, priceUSD: 214, duration: '3D/2N', groupSize: 25, rating: 4.4, reviewCount: 43, images: ['https://images.unsplash.com/photo-1569336415962-a4bd9f69d07e?w=600&h=400&fit=crop'], amenities: [], itinerary: [], included: [], excluded: [], featured: false, createdAt: '' },
      ];
