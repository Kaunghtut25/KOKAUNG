...
const MYANMAR_TOURS: (Tour & { image: string })[] = [
  { _id: 'm1', slug: 'golden-land-explorer', title: 'Golden Land Explorer', destination: 'Yangon-Bagan-Mandalay-Inle', priceMMK: 1850000, priceUSD: 881, duration: '8D/7N', durationUnit: 'Days', rating: 4.8, reviewCount: 142, image: '/images/unsplash-35.jpg', images: ['/images/unsplash-35.jpg'], amenities: ['Hotel', 'Breakfast', 'Guide', 'Transport'], featured: true, description: '', groupSize: 20, itinerary: [], included: [], excluded: [], createdAt: '' },
  { _id: 'm2', slug: 'bagan-sunrise-discovery', title: 'Bagan Sunrise Discovery', destination: 'Bagan', priceMMK: 950000, priceUSD: 452, duration: '5D/4N', durationUnit: 'Days', rating: 4.9, reviewCount: 98, image: '/images/unsplash-28.jpg', images: ['/images/unsplash-28.jpg'], amenities: ['Hotel', 'Breakfast', 'E-Bike', 'Boat Cruise'], featured: true, description: '', groupSize: 15, itinerary: [], included: [], excluded: [], createdAt: '' },
  { _id: 'm3', slug: 'mandalay-royal-heritage', title: 'Mandalay Royal Heritage', destination: 'Mandalay', priceMMK: 750000, priceUSD: 357, duration: '4D/3N', durationUnit: 'Days', rating: 4.6, reviewCount: 67, image: '/images/unsplash-39.jpg', images: ['/images/unsplash-39.jpg'], amenities: ['Hotel', 'Breakfast', 'Boat Trip', 'Guide'], featured: false, description: '', groupSize: 20, itinerary: [], included: [], excluded: [], createdAt: '' },
  { _id: 'm4', slug: 'inle-lake-serenity', title: 'Inle Lake Serenity', destination: 'Inle Lake', priceMMK: 1100000, priceUSD: 524, duration: '5D/4N', durationUnit: 'Days', rating: 4.7, reviewCount: 85, image: '/images/unsplash-36.jpg', images: ['/images/unsplash-36.jpg'], amenities: ['Hotel', 'Breakfast', 'Boat Tour', 'Canoe'], featured: true, description: '', groupSize: 16, itinerary: [], included: [], excluded: [], createdAt: '' },
  { _id: 'm5', slug: 'ngapali-beach-escape', title: 'Ngapali Beach Escape', destination: 'Ngapali Beach', priceMMK: 1350000, priceUSD: 643, duration: '4D/3N', durationUnit: 'Days', rating: 4.5, reviewCount: 52, image: '/images/unsplash-8.jpg', images: ['/images/unsplash-8.jpg'], amenities: ['Resort', 'Breakfast', 'Snorkeling', 'Beach'], featured: false, description: '', groupSize: 18, itinerary: [], included: [], excluded: [], createdAt: '' },
  { _id: 'm6', slug: 'yangon-cultural-tour', title: 'Yangon Cultural Tour', destination: 'Yangon', priceMMK: 450000, priceUSD: 214, duration: '3D/2N', durationUnit: 'Days', rating: 4.4, reviewCount: 43, image: '/images/unsplash-35.jpg', images: ['/images/unsplash-35.jpg'], amenities: ['Hotel', 'Breakfast', 'Train Ride', 'Tea Shop'], featured: false, description: '', groupSize: 25, itinerary: [], included: [], excluded: [], createdAt: '' },
  { _id: 'm7', slug: 'myeik-archipelago-adventure', title: 'Myeik Archipelago Adventure', destination: 'Myeik', priceMMK: 2200000, priceUSD: 1048, duration: '6D/5N', durationUnit: 'Days', rating: 4.9, reviewCount: 37, image: '/images/unsplash-30.jpg', images: ['/images/unsplash-30.jpg'], amenities: ['Boat Cabin', 'All Meals', 'Snorkeling', 'Kayak'], featured: true, description: '', groupSize: 12, itinerary: [], included: [], excluded: [], createdAt: '' },
  { _id: 'm8', slug: 'yangon-mandalay-express', title: 'Yangon-Mandalay Express', destination: 'Yangon-Mandalay', priceMMK: 550000, priceUSD: 262, duration: '3D/2N', durationUnit: 'Days', rating: 4.3, reviewCount: 38, image: '/images/unsplash-35.jpg', images: ['/images/unsplash-35.jpg'], amenities: ['Hotel', 'Breakfast', 'Flight', 'Guide'], featured: false, description: '', groupSize: 22, itinerary: [], included: [], excluded: [], createdAt: '' },
  { _id: 'm9', slug: 'shan-highland-trek', title: 'Shan Highland Trek', destination: 'Kalaw-Inle', priceMMK: 850000, priceUSD: 405, duration: '5D/4N', durationUnit: 'Days', rating: 4.8, reviewCount: 45, image: '/images/unsplash-7.jpg', images: ['/images/unsplash-7.jpg'], amenities: ['Homestay', 'All Meals', 'Guide', 'Porter'], featured: true, description: '', groupSize: 12, itinerary: [], included: [], excluded: [], createdAt: '' },
  { _id: 'm10', slug: 'mrauk-u-ancient-kingdoms', title: 'Mrauk U Ancient Kingdoms', destination: 'Mrauk U', priceMMK: 950000, priceUSD: 452, duration: '4D/3N', durationUnit: 'Days', rating: 4.7, reviewCount: 24, image: '/images/unsplash-40.jpg', images: ['/images/unsplash-40.jpg'], amenities: ['Hotel', 'Breakfast', 'Boat', 'Guide'], featured: false, description: '', groupSize: 12, itinerary: [], included: [], excluded: [], createdAt: '' },
  { _id: 'm11', slug: 'hpa-an-cave-explorer', title: 'Hpa-An Cave Explorer', destination: 'Hpa-An', priceMMK: 420000, priceUSD: 200, duration: '3D/2N', durationUnit: 'Days', rating: 4.5, reviewCount: 31, image: '/images/unsplash-35.jpg', images: ['/images/unsplash-35.jpg'], amenities: ['Hotel', 'Breakfast', 'Boat', 'Guide'], featured: false, description: '', groupSize: 18, itinerary: [], included: [], excluded: [], createdAt: '' },
  { _id: 'm12', slug: 'pyin-oo-lwin-flower-festival', title: 'Pyin Oo Lwin Flower Festival', destination: 'Pyin Oo Lwin', priceMMK: 550000, priceUSD: 262, duration: '4D/3N', durationUnit: 'Days', rating: 4.4, reviewCount: 27, image: '/images/unsplash-38.jpg', images: ['/images/unsplash-38.jpg'], amenities: ['Hotel', 'Breakfast', 'Gardens', 'Coffee Tour'], featured: false, description: '', groupSize: 18, itinerary: [], included: [], excluded: [], createdAt: '' },
];

const INTERNATIONAL_TOURS: (Tour & { image: string })[] = [
  { _id: 'i1', slug: 'bangkok-pattaya-luxury', title: 'Bangkok-Pattaya Luxury', destination: 'Thailand', priceMMK: 1650000, priceUSD: 786, duration: '5D/4N', durationUnit: 'Days', rating: 4.5, reviewCount: 76, image: '/images/unsplash-9.jpg', images: ['/images/unsplash-9.jpg'], amenities: ['Hotel', 'Breakfast', 'Island Tour', 'Guide'], featured: false, description: '', groupSize: 22, itinerary: [], included: [], excluded: [], createdAt: '' },
  { _id: 'i2', slug: 'singapore-city-lights', title: 'Singapore City Lights', destination: 'Singapore', priceMMK: 2100000, priceUSD: 1000, duration: '4D/3N', durationUnit: 'Days', rating: 4.7, reviewCount: 63, image: '/images/unsplash-15.jpg', images: ['/images/unsplash-15.jpg'], amenities: ['Hotel', 'Breakfast', 'Gardens', 'Sentosa'], featured: false, description: '', groupSize: 18, itinerary: [], included: [], excluded: [], createdAt: '' },
  { _id: 'i3', slug: 'angkor-wat-discovery', title: 'Angkor Wat Discovery', destination: 'Cambodia', priceMMK: 1450000, priceUSD: 690, duration: '4D/3N', durationUnit: 'Days', rating: 4.5, reviewCount: 54, image: '/images/unsplash-30.jpg', images: ['/images/unsplash-30.jpg'], amenities: ['Hotel', 'Breakfast', 'Tuk-Tuk', 'Boat'], featured: false, description: '', groupSize: 20, itinerary: [], included: [], excluded: [], createdAt: '' },
  { _id: 'i4', slug: 'vietnam-heritage-trail', title: 'Vietnam Heritage Trail', destination: 'Vietnam', priceMMK: 2400000, priceUSD: 1143, duration: '7D/6N', durationUnit: 'Days', rating: 4.8, reviewCount: 82, image: '/images/unsplash-27.jpg', images: ['/images/unsplash-27.jpg'], amenities: ['Hotel', 'Breakfast', 'Cruise', 'Guide'], featured: true, description: '', groupSize: 18, itinerary: [], included: [], excluded: [], createdAt: '' },
  { _id: 'i5', slug: 'bali-paradise-escape', title: 'Bali Paradise Escape', destination: 'Indonesia', priceMMK: 1950000, priceUSD: 929, duration: '5D/4N', durationUnit: 'Days', rating: 4.7, reviewCount: 59, image: '/images/unsplash-19.jpg', images: ['/images/unsplash-19.jpg'], amenities: ['Resort', 'Breakfast', 'Temples', 'Spa'], featured: true, description: '', groupSize: 16, itinerary: [], included: [], excluded: [], createdAt: '' },
  { _id: 'i6', slug: 'japan-cherry-blossom-tour', title: 'Japan Cherry Blossom Tour', destination: 'Japan', priceMMK: 3850000, priceUSD: 1833, duration: '7D/6N', durationUnit: 'Days', rating: 4.9, reviewCount: 72, image: '/images/unsplash-14.jpg', images: ['/images/unsplash-14.jpg'], amenities: ['Hotel', 'Breakfast', 'JR Pass', 'Tea Ceremony'], featured: true, description: '', groupSize: 14, itinerary: [], included: [], excluded: [], createdAt: '' },
  { _id: 'i7', slug: 'golden-triangle-explorer', title: 'Golden Triangle Explorer', destination: 'Myanmar-Thailand-Laos', priceMMK: 3500000, priceUSD: 1667, duration: '10D/9N', durationUnit: 'Days', rating: 4.6, reviewCount: 29, image: '/images/unsplash-30.jpg', images: ['/images/unsplash-30.jpg'], amenities: ['Hotel', 'Breakfast', 'Cruise', 'Guide'], featured: false, description: '', groupSize: 15, itinerary: [], included: [], excluded: [], createdAt: '' },
  { _id: 'i8', slug: 'maldives-honeymoon-special', title: 'Maldives Honeymoon Special', destination: 'Maldives', priceMMK: 3200000, priceUSD: 1524, duration: '4D/3N', durationUnit: 'Days', rating: 4.9, reviewCount: 44, image: '/images/unsplash-12.jpg', images: ['/images/unsplash-12.jpg'], amenities: ['Overwater Villa', 'Full Board', 'Spa', 'Cruise'], featured: true, description: '', groupSize: 2, itinerary: [], included: [], excluded: [], createdAt: '' },
  { _id: 'i9', slug: 'south-korea-discovery', title: 'South Korea Discovery', destination: 'South Korea', priceMMK: 2950000, priceUSD: 1405, duration: '6D/5N', durationUnit: 'Days', rating: 4.6, reviewCount: 41, image: '/images/unsplash-17.jpg', images: ['/images/unsplash-17.jpg'], amenities: ['Hotel', 'Breakfast', 'KORAIL', 'Jeju'], featured: false, description: '', groupSize: 16, itinerary: [], included: [], excluded: [], createdAt: '' },
  { _id: 'i10', slug: 'dubai-luxury-experience', title: 'Dubai Luxury Experience', destination: 'UAE', priceMMK: 2750000, priceUSD: 1310, duration: '5D/4N', durationUnit: 'Days', rating: 4.7, reviewCount: 88, image: '/images/unsplash-10.jpg', images: ['/images/unsplash-10.jpg'], amenities: ['Hotel', 'Breakfast', 'Burj Khalifa', 'Desert Safari'], featured: false, description: '', groupSize: 20, itinerary: [], included: [], excluded: [], createdAt: '' },
];
