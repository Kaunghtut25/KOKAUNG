...
export default function TourDetailPage() {
  ...
  // FIX 2026-08-17: heroImage/displayHero were ALSO dropped by 5c6d3a0 — same crash class.
  const heroImage = tour?.images?.[0] || PLACEHOLDER_IMG;
  const displayHero = imgError ? PLACEHOLDER_IMG : heroImage;

  // FIX 2026-08-17: renderStars was ALSO dropped by 5c6d3a0 (same crash class) — restored verbatim.
