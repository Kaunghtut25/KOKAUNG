...
const DEFAULT_CRUISES: Cruise[] = [
  ...
  { _id: 'cr2', id: 'cr2', title: 'Mekong River Cruise', destination: 'Cambodia', description: 'Journey along the legendary Mekong River.', priceMMK: 920000, priceUSD: 440, duration: '5 Days / 4 Nights', images: ['/images_v2/hero-cruises-v2.jpg'], amenities: 'Deluxe Cabin, River View', included: 'Cabin, Meals, Tours', excluded: 'Flights, Insurance' },
  { _id: 'cr3', id: 'cr3', title: 'Andaman Sea Cruise', destination: 'Thailand', description: 'Island hopping in the Andaman Sea.', priceMMK: 580000, priceUSD: 276, duration: '4 Days / 3 Nights', images: ['/images_v2/hero-cruises-v2.jpg'], amenities: 'Beach Cabins, Snorkeling', included: 'Cabin, Meals, Snorkeling', excluded: 'Flights, Tips' },
  { _id: 'cr4', id: 'cr4', title: 'Singapore Strait Cruise', destination: 'Singapore', description: 'Luxury cruise around Singapore.', priceMMK: 1200000, priceUSD: 571, duration: '3 Days / 2 Nights', images: ['/images_v2/hero-cruises-v2.jpg'], amenities: 'Suite, Fine Dining, Pool', included: 'Suite, All Meals', excluded: 'Flights, Alcohol' },
