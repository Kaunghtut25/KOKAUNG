...
const FALLBACK_POSTS: BlogPost[] = [
  { _id: '1', slug: 'top-10-destinations-myanmar', title: 'Top 10 Must-Visit Destinations in Myanmar',
    ...
    image: 'https://vydupdjfr38dxlzx.public.blob.vercel-storage.com/uploads/img_1784610038946_65c91n-top-10-destinations-myanmar-NP6mCVq7KG8y8L5eqDQ2I1vAk0Su0e.jpg', author: 'A9 Global Team', tags: ['Myanmar', 'Travel Tips', 'Destinations'], createdAt: '2024-12-15' },
  { _id: '2', slug: 'flight-deals-guide', title: 'How to Get the Best Flight Deals in 2025',
    ...
    image: 'https://vydupdjfr38dxlzx.public.blob.vercel-storage.com/uploads/img_1784610040044_4bcr2r-flight-deals-guide-g8n2BkURo2sh14Sxk0XX7gFvaH0NxM.jpg', author: 'A9 Global Team', tags: ['Flights', 'Travel Tips', 'Budget'], createdAt: '2024-12-20' },
  { _id: '3', slug: 'visa-guide-2025', title: 'Visa Guide 2025: Everything You Need to Know',
    ...
    image: 'https://vydupdjfr38dxlzx.public.blob.vercel-storage.com/uploads/img_1784610041576_otqn3d-visa-guide-2025-4bXjyO2HPVFXTkBxaDk7FgqD2NxFJq.jpg', author: 'A9 Global Team', tags: ['Visa', 'Guide', 'International'], createdAt: '2025-01-05' },
  { _id: '4', slug: 'best-time-visit-thailand', title: 'Best Time to Visit Thailand: Month by Month Guide',
    ...
    image: 'https://vydupdjfr38dxlzx.public.blob.vercel-storage.com/uploads/img_1784610042763_ww29t2-best-time-visit-thailand-cNsvSROXLaTCISF6XdkNn1EuzFnTKJ.jpg', author: 'A9 Global Team', tags: ['Thailand', 'Seasons', 'Travel Tips'], createdAt: '2025-01-10' },
  { _id: '5', slug: 'top-5-luxury-hotels-yangon', title: 'Top 5 Luxury Hotels in Yangon for Business Travelers',
    ...
    image: 'https://vydupdjfr38dxlzx.public.blob.vercel-storage.com/uploads/img_1784610044061_os4u78-top-5-luxury-hotels-yangon-hTsRNp9iSp6ky5pJCbs58lseH23KOY.jpg', author: 'A9 Global Team', tags: ['Hotels', 'Yangon', 'Luxury'], createdAt: '2025-01-15' },
  { _id: '6', slug: 'dubai-travel-guide', title: 'Dubai Travel Guide: What to See, Do, and Eat',
    ...
    image: 'https://vydupdjfr38dxlzx.public.blob.vercel-storage.com/uploads/img_1784610045156_53t6r8-dubai-travel-guide-VP0y4hvxTQBbkhMVa1n9NJaSzLeRjd.jpg', author: 'A9 Global Team', tags: ['Dubai', 'Destinations', 'Guide'], createdAt: '2025-01-20' },
  { _id: '7', slug: 'travel-insurance-why-need', title: 'Why You Need Travel Insurance: Real Stories from Travelers',
    ...
    image: 'https://vydupdjfr38dxlzx.public.blob.vercel-storage.com/uploads/img_1784610046349_3mlriw-travel-insurance-why-need-XTtg0I4Q5a3AM9vLjfpSVZtbbUMzIn.jpg', author: 'A9 Global Team', tags: ['Insurance', 'Safety', 'Tips'], createdAt: '2025-01-25' },
  { _id: '8', slug: 'korean-food-guide', title: 'Korean Food Lover\'s Guide: 15 Must-Try Dishes in Seoul',
    ...
    image: 'https://vydupdjfr38dxlzx.public.blob.vercel-storage.com/uploads/img_1784610047813_ydfow2-korean-food-guide-RYAc29UY9B6ESwzlkmzWcKpPnsE1Jf.jpg', author: 'A9 Global Team', tags: ['Korea', 'Food', 'Culture'], createdAt: '2025-02-01' },
  { _id: '9', slug: 'sustainable-travel-tips', title: '10 Easy Ways to Travel More Sustainably in 2025',
    ...
    image: 'https://vydupdjfr38dxlzx.public.blob.vercel-storage.com/uploads/img_1784610049317_6pfizj-sustainable-travel-tips-ymCqaC3sltUHFSdDtR0KhNnycNfP6m.jpg', author: 'A9 Global Team', tags: ['Sustainability', 'Tips', 'Eco-Travel'], createdAt: '2025-02-05' },
  { _id: '10', slug: 'singapore-family-holiday', title: 'Singapore Family Holiday: Complete Itinerary for 5 Days',
    ...
    image: 'https://vydupdjfr38dxlzx.public.blob.vercel-storage.com/uploads/img_1784610050448_0uq8l4-singapore-family-holiday-Ak7CMvI4pA4nBFhUVn7Xkex7Ds9CGR.jpg', author: 'A9 Global Team', tags: ['Singapore', 'Family', 'Itinerary'], createdAt: '2025-02-10' },
  { _id: '11', slug: 'bagan-hot-air-balloon-guide', title: 'Bagan Hot Air Balloon Guide: Everything You Need to Know',
    ...
    image: 'https://vydupdjfr38dxlzx.public.blob.vercel-storage.com/uploads/img_1784610051525_2it0yf-bagan-hot-air-balloon-guide-X8Ir4OV1XLpQe1KSPDeXq8yVW5dPat.jpg', author: 'A9 Global Team', tags: ['Bagan', 'Balloon', 'Myanmar', 'Adventure'], createdAt: '2025-02-15' },
];

export default function BlogClient({ siteConfig }: { siteConfig: any }) {
  const [heroImage, setHeroImage] = useState(siteConfig?.heroImages?.blog || "https://vydupdjfr38dxlzx.public.blob.vercel-storage.com/uploads/img_1784609799332_6ebnns-hero-blog-mBap03GJD1400JSclYnUjYfHoo3frB.jpg");
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="relative h-[300px] md:h-[380px] w-full overflow-hidden" style={{ height: (siteConfig?.heroDimensions?.["blog"]?.desktop || 380) + "px" }}>
        <Image alt="A9 Global Blog" className="w-full h-full object-cover" onError={(e) => { (e.target as HTMLImageElement).src = "https://vydupdjfr38dxlzx.public.blob.vercel-storage.com/uploads/img_1784609799332_6ebnns-hero-blog-mBap03GJD1400JSclYnUjYfHoo3frB.jpg"; }} src={heroImage} width={1600} height={900} sizes="100vw" />
          ...
          {displayPosts.map((post) => (
            ...
            >
              <div className="relative h-48 overflow-hidden">
                <Image alt={post.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" onError={(e) => { (e.target as HTMLImageElement).src = 'https://vydupdjfr38dxlzx.public.blob.vercel-storage.com/uploads/img_1784609663178_ta1biy-bangkok-x7Q8kUMuXRvj6qMJAZxBbawKS4zkjI.jpg'; }} src={post.image} width={1600} height={900} sizes="100vw" />
              </div>
              <div className="p-5">
