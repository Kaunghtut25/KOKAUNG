...
const FALLBACK_BLOG_POSTS: any[] = [
  { id: "b1", _id: "b1", title: "Top 10 Must-Visit Destinations in Myanmar", content: "From the ancient temples of Bagan to the serene waters of Inle Lake, Myanmar offers an unparalleled travel experience for adventurers and culture seekers alike. Explore the golden Shwedagon Pagoda in Yangon, trek through the Shan Hills, and discover hidden gems in Mandalay's royal city.", author: "A9 Global Travel Team", tags: ["Myanmar", "Destinations", "Travel Guide"], slug: "top-10-must-visit-destinations-myanmar", image: "/images_v2/blog1-v2.jpg", createdAt: "2026-01-15" },
  { id: "b2", _id: "b2", title: "Best Time to Visit Southeast Asia", content: "Planning a trip to Southeast Asia? November to February offers the best weather with cool, dry days perfect for temple hopping and beach relaxation. March to May brings higher temperatures, while June to October sees monsoon rains that transform landscapes into lush green paradises.", author: "A9 Global Travel Team", tags: ["Southeast Asia", "Travel Tips", "Weather"], slug: "best-time-to-visit-southeast-asia", image: "/images_v2/blog2-v2.jpg", createdAt: "2026-01-20" },
  { id: "b3", _id: "b3", title: "Visa Guide: ASEAN Countries for Myanmar Citizens", content: "A comprehensive guide covering visa policies for all ASEAN nations for Myanmar passport holders. Learn about visa-free destinations like Singapore (30 days), Thailand (14 days), and Vietnam (30-day eVisa). We also cover application processes, fees, and processing times.", author: "A9 Global Travel Team", tags: ["Visa", "ASEAN", "Travel Guide", "Myanmar"], slug: "visa-guide-asean-countries-myanmar", image: "/images_v2/visa-v2.jpg", createdAt: "2026-01-25" },
  { id: "b4", _id: "b4", title: "Myanmar Travel Budget Guide: What Things Really Cost", content: "A transparent breakdown of travel costs in Myanmar for 2026. From $15 guesthouses to $200+ luxury resorts, street food at $1-$3 to fine dining at $20-$50. We cover transportation, attractions, guides, and hidden costs most travelers overlook.", author: "A9 Global Travel Team", tags: ["Myanmar", "Budget", "Travel Tips"], slug: "myanmar-travel-budget-guide", image: "/images_v2/tour-bagan-v2.jpg", createdAt: "2026-02-01" },
  { id: "b5", _id: "b5", title: "How to Choose the Right Travel Insurance", content: "Not all travel insurance is created equal. Compare coverage types: medical emergency, trip cancellation, lost baggage, adventure sports, and COVID-19 coverage. Learn what makes a good policy and which red flags to avoid before booking your next trip.", author: "A9 Global Travel Team", tags: ["Insurance", "Travel Tips", "Safety"], slug: "how-to-choose-travel-insurance", image: "/images_v2/ins1-v2.jpg", createdAt: "2026-02-08" },
  { id: "b6", _id: "b6", title: "Bagan Hot Air Balloon Season: Complete Guide", content: "The Bagan hot air balloon season runs from October to April, offering breathtaking sunrise views over thousands of ancient temples. Pricing ranges from $300-$450 per person. Book at least 2 weeks in advance during peak season (December-February).", author: "A9 Global Travel Team", tags: ["Bagan", "Myanmar", "Adventure"], slug: "bagan-hot-air-balloon-season-guide", image: "/images_v2/blog1-v2.jpg", createdAt: "2026-02-12" },
  { id: "b7", _id: "b7", title: "Hidden Gem Destinations in Myanmar", content: "Beyond Bagan and Inle Lake lie Myanmar's best-kept secrets. Explore the ancient kingdom of Mrauk U, hike to the remote Putao Valley in Kachin State, discover Hpa An's mystical caves, and sail the untouched Mergui Archipelago.", author: "A9 Global Travel Team", tags: ["Myanmar", "Hidden Gems", "Adventure"], slug: "hidden-gem-destinations-myanmar", image: "/images_v2/blog2-v2.jpg", createdAt: "2026-02-18" },
  { id: "b8", _id: "b8", title: "Cruise Guide: Best River and Sea Cruises in Southeast Asia", content: "From luxury Mekong River cruises to Halong Bay junk boats and Andaman Sea island-hopping adventures, Southeast Asia offers some of the world's most spectacular cruise experiences. Compare routes, pricing, seasons, and onboard amenities.", author: "A9 Global Travel Team", tags: ["Cruises", "Southeast Asia", "Travel Guide"], slug: "cruise-guide-southeast-asia", image: "/images_v2/hero-cruises-v2.jpg", createdAt: "2026-02-25" },
  { id: "b9", _id: "b9", title: "Best Street Foods of Southeast Asia You Must Try", content: "A culinary journey through Southeast Asia's vibrant street food scene. From Bangkok's legendary pad thai to Yangon's comforting mohinga, Penang's char kway teow to Hanoi's steaming pho. Our guide to the best street eats in every major city.", author: "A9 Global Travel Team", tags: ["Food", "Southeast Asia", "Culture"], slug: "best-street-foods-southeast-asia", image: "/images_v2/dest-korea-v2.jpg", createdAt: "2026-03-01" },
  { id: "b10", _id: "b10", title: "10 Essential Tips for First-Time Travelers to Asia", content: "First time in Asia? Here's what you need to know: pack light with breathable fabrics, respect temple dress codes (cover shoulders and knees), always carry cash (many places don't accept cards), download offline maps and translation apps, and embrace the organized chaos — it's part of the adventure!", author: "A9 Global Travel Team", tags: ["Travel Tips", "Asia", "Beginner"], slug: "10-essential-tips-first-time-travelers-asia", image: "/images_v2/tour-beach-v2.jpg", createdAt: "2026-03-08" },
];
